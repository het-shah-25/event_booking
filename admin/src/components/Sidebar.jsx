          ...
          <ul class="space-y-2 font-medium">
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h14a1 1 0 001-1V4a1 1 0 00-1-1H3zm0 2h2v10H3V5zm4 4h2v6H7V9zm4-2h2v8h-2V7zm4 4h2v4h-2v-4z"
                  clipRule="evenodd"
                />
              </svg>
              <span className="flex-1 ml-3 whitespace-nowrap">Poll List</span>
            </li>
      ...
      <div class="p-4 sm:ml-64">
        <div class="p-4  mt-14">
          <Routes>
            ...
            <Route path="/Poll-list" element={<Poll />} />
